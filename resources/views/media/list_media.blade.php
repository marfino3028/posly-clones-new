...
@section('main-content')
    ...
    <div class="row" id="section_Media_list">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="text-end mb-3">
                        <a class="btn btn-outline-primary btn-md m-1" href="{{ route('media.create') }}"><i
                                class="i-Add me-2 font-weight-bold"></i>Create</a>
                    </div>
                    <div class="table-responsive">
                        <table id="media_list_table" class="display table">
                            <thead>
                            <tr>
                                <th>ID</th>
...
@section('page-js')
    ...
    <script type="text/javascript">
        $(function(){
                ...
                swal({
                    ...
                    axios
                        ...
                        .then(() => {
                            ...
                            $('#media_list_table').DataTable().ajax.reload();
                        })
                        .catch(() => {
            ...
            //Get Data
            function media_datatable() {
                var table = $('#media_list_table').DataTable({
                    processing: true,
                    serverSide: true,
                    "order": [[ 0, "desc" ]],
                    'columnDefs': [
            ...
            $(document).bind('event_client', function (e) {
                $('#media_list_table').DataTable().destroy();
                media_datatable();
            });
        });
    </script>
