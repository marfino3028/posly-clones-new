...
@section('main-content')
    ...
    <div class="row" id="section_Client_list">
                            ...
                            <form @submit.prevent="Submit_Payment_sell_return_due()">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea type="text" v-model="payment_return.notes" class="form-control"
                                                  name="note" id="note"
                                                  placeholder="{{ __('translate.Please_provide_any_details') }}"></textarea>
                                    </div>
        ...
        <validation-observer ref="import_user_modal">
            <div class="modal fade" id="import_user_modal" tabindex="-1" role="dialog"
                 aria-labelledby="import_user_modal" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form @submit.prevent="Import_Client_Excel()">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <validation-provider name="clients" rules="required" v-slot="validationContext">
                                            <div class="form-group">
                                                ...
                                                <input name="excel" @change="changeFile" type="file"
                                                       class="form-control" id="excel">
                                    ...
                                    <div class="col-lg-12">
                                        <button type="submit" class="btn btn-primary"
                                                :disabled="import_client_Processing">
