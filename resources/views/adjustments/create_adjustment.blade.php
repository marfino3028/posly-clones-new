                            ...
                            <div class="form-group col-md-6">
                                <validation-provider name="warehouse" rules="required" v-slot="{ valid, errors }">
                                    ...
                                    <v-select @input="Selected_Warehouse" :disabled="details.length > 0"
                                        ...
                                        v-model="adjustment.warehouse_id" :reduce="(option) => option.value"
                                            ...
                                            <tr v-for="detail in details" :key="detail.detail_id">
                                                ...
                                                <td>
                                                    <select v-model="detail.type"
                                                        @change="Verified_Qty(detail,detail.detail_id)" type="text"
                                                        required class="form-control">
                                                        <option value="add">{{ __('translate.Addition') }}</option>
                                                        <option value="sub">{{ __('translate.Subtraction') }}
                                                        </option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <a @click="Remove_Product(detail.detail_id)"
            ...
            search() {
                ...
                if (this.adjustment.warehouse_id != "" && this.adjustment.warehouse_id != null) {
                    this.timer = setTimeout(() => {
                        const product_filter = this.products.filter(product => product.code === this
                            .search_input);
